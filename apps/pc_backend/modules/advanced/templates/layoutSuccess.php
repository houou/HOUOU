...
<li><?php echo link_to($config['name'].'レイアウト設定', 'advanced/layout?type='.$key) ?></li>
<?php endforeach; ?>
</ul>

<?php echo $form->renderFormTag(url_for('advanced/layout?type='.$sf_request->getParameter('type', 'gadget'))) ?>
